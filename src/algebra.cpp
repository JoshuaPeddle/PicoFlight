...
void do_stuff()
{
    ...
    BLA::Matrix<6, 6> A = {16, 78, 50, 84, 70, 63, 2,  32, 33, 61, 40, 17, 96, 98, 50, 80, 78, 27,
                      86, 49, 57, 10, 42, 96, 44, 87, 60, 67, 16, 59, 53, 8,  64, 97, 41, 90};

    BLA::Matrix<6> b = {3, 99, 95, 72, 57, 43};
    ...
    BLA::Matrix<6> x_lusolve = LUSolve(decomp, b);
    ...
    BLA::Matrix<6> another_b = {23, 19, 86, 3, 23, 90};
